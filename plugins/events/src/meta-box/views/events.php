...
<div class="pre-post-concert-info">
    <p>
        <label for="pre-post-concert-info"><strong>Pre- & Post-Concert Information</strong></label>
    </p>
    <p>
        <input id="supplemental-event-info" class="large-text" type="text" name="<?php echo $meta_box_id; ?>[pre-post-concert-info-text-field]"
               value="<?php echo esc_attr( $custom_fields['pre-post-concert-info-text-field'] ); ?>">
    </p>
    <p>
        <span class="description">Enter pre- & post-concert information ( e.g. door opening time, refreshments, etc.).
        Will appear in 'Event Information' field after Event content.</span>
    </p>
</div>
<hr>
...
<div>
    ...
    <p>
        <span class="description">Parking availability at the performance location.</span>
    </p>
    <p>
        <label for="admission-text-field">Parking Text Field</label>
    </p>
    <p>
        <input id="parking-text-field" class="large-text" type="text"
               name="<?php echo $meta_box_id; ?>[parking-text-field]"
               value="<?php echo esc_attr( $custom_fields['parking-text-field'] ); ?>">
    </p>
    <p>
    <span class="description">Describe on-site and nearby parking availability.
    </p>
</div>
<hr>
<div>
