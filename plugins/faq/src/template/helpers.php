 ...
 * @since 1.0.0
 *
 * @param int   $faq_count The faq's spot in the grid.
 * @param int   $post_id   The post ID, an [faq] shortcode attribute.
 * @param array $classes   Optional. Starting classes to add new classes to.
 *
 * @return string
 */
function get_faq_post_classes( $faq_count, $post_id = 0, array $classes = array() ) {
