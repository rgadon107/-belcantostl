...
add_filter( 'add_custom_post_type_runtime_config', __NAMESPACE__ . '\register_songs_custom_configs', 9 );
add_filter( 'add_custom_taxonomy_runtime_config', __NAMESPACE__ . '\register_songs_custom_configs', 9 );
/**
 ...
 */
function register_songs_custom_configs( array $configurations ) {
